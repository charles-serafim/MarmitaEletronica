...
namespace Funcionarios
{
    internal class FuncionariosLogica: JsonParser
    {
        ...
        public List<Funcionario> funcionariosItems = JsonParser.ReceberJson< Funcionario>(@"C:\Users\luanar\source\repos\MarmitaEletronica\Funcionarios\Funcionarios.json");
